...
{
	ConvString( ( const char * )L"", -1, LINUX_WCHAR_CHARCODEFORMAT, Buffer, BufferBytes, CHAR_CHARCODEFORMAT ) ;
...
{
	ConvString( ( const char * )L"", -1, LINUX_WCHAR_CHARCODEFORMAT, ( char * )Buffer, BufferBytes, WCHAR_T_CHARCODEFORMAT ) ;
...
extern int _CHDIR( const char *DirName )
{
	...
	ConvString( DirName, -1, CHAR_CHARCODEFORMAT, ( char * )TempBuffer, sizeof( TempBuffer ), LINUX_WCHAR_CHARCODEFORMAT ) ;
