// -------------------------------------------------------------------------------
// 
// 		ＤＸライブラリ		Live2D Cubism4関係ヘッダファイル( Linux )
// 
// 				Ver 3.24f
// 
// -------------------------------------------------------------------------------

#ifndef DX_LIVE2DCUBISM4LINUX_H
#define DX_LIVE2DCUBISM4LINUX_H
...
{
	GRAPHICS_LINUX_SHADER Shader[ LIVE2D_SHADER_Num ] ;
} ;
