// -------------------------------------------------------------------------------
// 
// 		ＤＸライブラリ		Linux用マスクデータ管理プログラムヘッダファイル
// 
// 				Ver 3.24f
// 
// -------------------------------------------------------------------------------

#ifndef DX_MASKLINUX_H
#define DX_MASKLINUX_H
...
#define MASKLINUX					MaskManageData_Linux

// 構造体定義 --------------------------------------------------------------------

// Linux 用のマスク処理情報構造体
struct MASKMANAGEDATA_LINUX
{
...
extern MASKMANAGEDATA_LINUX MaskManageData_Linux ;
