// -------------------------------------------------------------------------------
// 
// 		ＤＸライブラリ		Linux用モデルデータ制御プログラムヘッダファイル
// 
// 				Ver 3.24f
// 
// -------------------------------------------------------------------------------

#ifndef DX_MODELLINUX_H
#define DX_MODELLINUX_H
...
extern MV1_MODEL_MANAGE_LINUX MV1Man_Linux ;

// 関数プロトタイプ宣言-----------------------------------------------------------

// 汎用バッファ関数
extern	int				MV1_LINUX_CommonBuffer_Setup( int Size ) ;						// 指定サイズの汎用バッファの準備を行う
extern	int				MV1_LINUX_CommonBuffer_Terminate( void ) ;						// 汎用バッファの後始末を行う
