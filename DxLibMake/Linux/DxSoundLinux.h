// -------------------------------------------------------------------------------
// 
// 		ＤＸライブラリ		Linux用サウンドプログラムヘッダファイル
// 
// 				Ver 3.24f
// 
// -------------------------------------------------------------------------------

#ifndef DX_SOUNDLINUX_H
#define DX_SOUNDLINUX_H
...
extern	void	SoundSystem_Linux_SetALDeviceAndALContext( void *ALCDevice, void *ALCContext ) ;

// 再生中の ALBuffer を再作成して再再生する
extern	void	SoundSystem_Linux_ALBuffer_RePlay( void ) ;
