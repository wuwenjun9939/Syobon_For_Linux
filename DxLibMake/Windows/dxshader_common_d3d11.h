...
{
	DX_D3D11_SHADER_INT			Mode ;					// フォグモード( DX_FOGMODE_LINEAR など )
	...
	DX_D3D11_SHADER_FLOAT		DensityStart ;			// フォグ用パラメータ density start

	DX_D3D11_SHADER_FLOAT		E ;						// フォグ用パラメータ 自然対数の低
	DX_D3D11_SHADER_FLOAT3		Padding2 ;				// パディング２
...
struct DX_D3D11_CONST_BUFFER_COMMON
{
	...
	DX_D3D11_VS_CONST_FOG		VerticalFog ;			// 高さフォグパラメータ
} ;
